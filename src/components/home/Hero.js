      ...
      <div className="max-w-4xl w-full mx-auto shadow-md bg-white/90 dark:bg-[#121212]/90 backdrop-blur-sm border border-gray-100 dark:border-neutral-700 p-4 sm:p-8 md:p-12 mb-8 sm:mb-12 transition-colors duration-300">
        ...
        <div className="mb-6 lg:mb-2 sm:mb-10 flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8">
          <div className="w-full md:w-[60%]">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-normal mb-4 sm:mb-5 text-black dark:text-white transition-colors">
              Hi!
            </h2>
          ...
          <div className="w-full md:w-[40%] flex justify-center md:justify-end mt-2 md:mt-0">
            <Image
              ...
              width={240}
              height={240}
              className="w-40 h-40 md:w-full md:h-auto aspect-square object-cover border border-gray-200 dark:border-gray-700 shadow-sm"
              priority
            />
          </div>
        </div>
        ...
        <div className="mt-8 sm:mt-10">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-normal mb-5 sm:mb-7 text-black dark:text-white transition-colors">
            Recent Work
          </h2>
              ...
              >
                ...
                <h3 className="text-base sm:text-lg font-normal mb-1 sm:mb-2 text-black dark:text-white transition-colors">
                  <a
                    ...
                    className="hover:text-gray-600 dark:hover:text-gray-300 transition-colors underline decoration-1 underline-offset-4"
                  >
                    {work.title}
                  </a>
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-xs sm:text-sm transition-colors">
                  {work.description}
                </p>
              </div>
            ))}
