    ...
    <section id="home" className="min-h-screen pt-32 md:pt-36 pb-10 md:pb-16 px-4 md:px-12 flex flex-col items-center">
      ...
      >
        ...
        <div className="flex flex-col-reverse md:flex-row items-start md:items-center justify-between gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <motion.div variants={itemVariants} className="shrink-0 relative group self-center md:self-auto">
            ...
            <Image
              ...
              width={280}
              height={280}
              className="relative z-10 w-56 h-56 sm:w-64 sm:h-64 object-cover rounded-[2rem] shadow-xl grayscale-[20%] group-hover:grayscale-0 transition-all duration-500 ease-out"
              priority
            />
          </motion.div>
        </div>
